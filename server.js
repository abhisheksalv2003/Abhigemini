...
//  const safety_settings = [
  ...
  const chat = model.startChat({
    ...
    history: [
      ...
      {
        role: "model",
        parts: [{ text: "Hi there! Thanks for reaching out to abhi bots. Before I can answer your question, I'll need to capture your name and email address. Can you please provide that information?"}],
      },
    ],
  });
